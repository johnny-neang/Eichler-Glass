        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <section>
              ...
              <p>
                When you book a service, you agree to provide accurate and complete information. A $50 non-refundable booking deposit is required to confirm your appointment. This deposit is applied toward your final invoice. Bookings are confirmed via email and calendar scheduling through our Cal.com integration.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>A $50 deposit is required at booking and is non-refundable</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">5. Rescheduling and Cancellations</h2>
              <p>
                Appointments must be rescheduled or cancelled at least 48 hours in advance. Cancellations made less than 48 hours before the scheduled service time will result in forfeiture of the $50 booking deposit. Please refer to our Cancellation Policy for complete details.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold mb-4">6. Property Access</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">7. Liability and Damages</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">8. Service Guarantee</h2>
              <p>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">9. Weather Conditions</h2>
              <p>
